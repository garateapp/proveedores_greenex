...
export default function PlantillaDocumentoTrabajadorCreate({
    tiposDocumentos,
    availableVariables,
    fontOptions,
    paperOptions,
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        tipo_documento_id: '',
        contenido_html: '',
        fuente_nombre: fontOptions[0]?.value ?? 'dejavu_sans',
        fuente_tamano: '12',
        color_texto: '#111827',
        formato_papel: paperOptions.find((option) => option.value === 'letter')?.value ?? 'letter',
        activo: true,
    });
    ...
    const submit: FormEventHandler = (event) => {
        ...
        post('/admin/plantillas-documentos-trabajador');
    };
    ...
    return (
        <>
            <Head title="Nueva Plantilla de Firma" />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Crea un documento formal para firma digital de trabajadores.
                        </p>
                    </div>
                </div>
...
PlantillaDocumentoTrabajadorCreate.layout = (page: ReactNode) => <AppLayout>{page}</AppLayout>;
