...
export default function CreateUser({ contratistas, roles }: Props) {
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                ...
                                {requiresContratista && (
                                    <div className="space-y-2">
                                        ...
                                        <Select
                                            value={data.contratista_id.toString()}
                                            onValueChange={(value) =>
...
CreateUser.layout = (page: React.ReactNode) => <AppLayout>{page}</AppLayout>;
